...
class Melter():
    def __init__(self, interruption: utils.InterruptibleProcess, duplicates_source: DuplicatesSource, live_run: bool, logger: logging.Logger, wd: str, output: str, languages_priority: List[str] = []):
...
class MeltTool(Tool):
    ...
    def run(self, args, no_dry_run: bool):
        ...
        melter = Melter(interruption,
                        data_source,
                        live_run = no_dry_run,
                        logger = logging.getLogger("MeltTool"),
                        wd = args.working_dir,
